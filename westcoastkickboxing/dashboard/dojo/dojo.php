		...
		<div class="col-md-6 col-sm-12 col-xs-12">
					  ...
					  <form method="post"  class="col-md-12 col-sm-12 col-xs-12">
							...
							<ul class="nav navbar-nav">
									<p>Back to Dashboard:	<li class="nav-item"><a class="nav-link"  href="../../registration/senseiDashboard.php"><i class="fas fa-arrow-left"></i></span><b> Dashboard</b></a></li>
			...
			<div class="col-md-6 col-sm-12 col-xs-12">								<!--parent CONTAINER-->
				  ...
				  <div class="header bg-primary col-md-12 col-sm-12 col-xs-12"> 		<!--parent child-->
					...
					<?php
								...
								{
								   $addRemark = mysqli_query($mysqli,"DELETE FROM dojo WHERE dojoID='$_POST[hidden]'");	//Delete query
								};
									
								$sql = "SELECT * FROM dojo";						//Populate the table
								...
								while($record = mysqli_fetch_array($myData)){
									...
									echo "<td><button class='btn bg-primary text-light' name='delete' id='delete' >Delete</button></td>";
									echo "</form>";
									}
								echo "</table>"; 
								mysqli_close($mysqli);
