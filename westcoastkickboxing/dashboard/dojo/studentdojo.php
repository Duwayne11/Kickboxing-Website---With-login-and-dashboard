...
<div class="container-fluid">
						...
						<h3>My West Coast Kick-Boxing</h3>
							...
							echo "<div class='table-responsive-sm'>";
								...
								while($record = mysqli_fetch_array($myData)){
									...
									echo "<td><button disabled class='btn bg-primary text-light' name='delete' id='delete' >Delete</button></td>";
									echo "</form>";
									}
								echo "</table>"; 
								echo "</div>";
	...
	<ul class="nav navbar-nav">
		<li class="nav-item"><a class="nav-link"  href="../../registration/studentDashboard.php"><i class="fas fa-arrow-left"></i></span><b> Dashboard</b></a></li>
